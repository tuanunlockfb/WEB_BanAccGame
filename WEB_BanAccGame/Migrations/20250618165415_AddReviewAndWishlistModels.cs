...
{
    /// <inheritdoc />
    public partial class AddReviewAndWishlistModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_GameAccounts_GameAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wishlists_GameAccounts_GameAccountId",
                        column: x => x.GameAccountId,
                        principalTable: "GameAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_GameAccountId",
                table: "Wishlists",
                column: "GameAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_GameAccountId",
                table: "Wishlists",
                columns: new[] { "UserId", "GameAccountId" },
                unique: true);
        }
