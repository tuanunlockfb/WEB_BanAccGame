        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Server = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameAccounts_GameCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_GameAccounts_GameAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameAccountId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    ShoppingCartId = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_GameAccounts_GameAccountId",
                        column: x => x.GameAccountId,
                        principalTable: "GameAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Multiplayer Online Battle Arena", "⚔️", "MOBA" },
                    { 4, "Last Man Standing Games", "🏆", "Battle Royale" },
                    { 5, "Survival Games", "🏕️", "Survival" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameAccounts_CategoryId",
                table: "GameAccounts",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_GameAccountId",
                table: "OrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_GameAccountId",
